...
public static class EPLConvert
{
    public static int Rotation(ElementDrawRotation rotation)
    {
        ...
        {
            ElementDrawRotation.NO_ROTATION => 0,
            ElementDrawRotation.ROTATE_90_DEGREES => 1,
            ElementDrawRotation.ROTATE_180_DEGREES => 2,
            ElementDrawRotation.ROTATE_270_DEGREES => 4,
            _ => 0,
        };
    }
}
